    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Visão geral do sistema de gestão de clientes</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="metric-card">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-1 font-medium">Lote_001</CardTitle>
          ...
          <CardContent>
            ...
            <div className="text-l font-bold">02/05/2025</div>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="max-w-2xl mx-auto">
            <Card>
              <CardHeader>
                ...
                <p className="text-muted-foreground text-sm mt-1">Selecione a ação desejada para os clientes auditados. Caso haja pontos de melhoria, descreva-os abaixo.</p>
              </CardHeader>
              <CardContent>
                <AuditActionsCard />
              </CardContent>
